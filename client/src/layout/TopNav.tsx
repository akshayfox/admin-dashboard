        ...
        <div className="flex items-center">
          ...
          <div className="relative hidden md:block">
            ...
            <input 
              type="search" 
              placeholder="Search..." 
              className="h-9 w-48 lg:w-64 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-400 dark:border-slate-800 dark:bg-slate-950 dark:focus:ring-slate-600 pl-9"
            />
          </div>
        </div>
